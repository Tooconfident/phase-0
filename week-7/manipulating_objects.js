...
// I worked on this challengeby myself.
...
/* What tests did you have trouble passing? What did you do to make it pass? Why did that work?
   The only test that became difficult to pass was the last. I was using the '===' for equal to notation instead of just '='.
   The three equals signs were used in the test to show they are the same value. This is only true though when the variables
   are defined to each other with just one equals sign in my code.*/


// How difficult was it to add and delete properties outside of the object itself?
// It seemed pretty straight forward using the delete to remove properties. 
// Adding involved dot notation because our variable were defined.


// What did you learn about manipulating objects in this challenge?
// Dot notation works for nested variables, once those variable property values are defined. 
// Manipulating objects is very easy, so if you accidently add a property you can simply delete it if its no use to the program.
// It is important to define what kind of object a variable is before you manipulate it.
// Once two variable have a relationship, you can define nested relationships as well and manipulate them accordingly.
